      ...
      <div className="auth-card pkl-register-card animate-fade-in-up">
        ...
        <form onSubmit={handleRegister} className="auth-form pkl-register-form">
          ...
          <div className="form-group pkl-register-upload">
            <label className="form-label">Surat Pengantar (PDF / Gambar)</label>
          ...
          <div className="form-group pkl-register-upload">
            <label className="form-label">Curriculum Vitae (CV) (PDF / Gambar)</label>
          ...
          <div className="form-group pkl-register-upload">
            <label className="form-label">Surat Lamaran (PDF / Gambar)</label>
